...
import com.greatlearning.email.credentialservices.CredentialServices; // importing CredentialServices class from com.greatlearning.email.credentialservices
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Employee emp = new Employee("Shoaib", "Ahmed");       // Creating object of class Employee and assigning parameters.
